...
class RPABotCore:
    ...
    def is_temporary_message_id(message_id: str) -> bool:
        ...
        Returns:
            True if the ID is temporary and should be skipped, False otherwise
        """
        if not message_id:
            return True

        # Temporary IDs: exactly 10 chars, alphanumeric, with at least one letter
        # Single regex checks: length=10, alphanumeric, contains at least one letter
    ...
    async def _process_message_batch(
        ...
        # Step 1: Pattern matching for all messages - capture actual pattern
        for msg_data in messages:
            msg_id = msg_data["id"]
